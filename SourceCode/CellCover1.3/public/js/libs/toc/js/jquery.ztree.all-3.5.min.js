...
(function (k) {
    var F, G, H, I, J, K, r = {}, L = {}, t = {}, M = {
        ...
        w = [function (b) {
            ...
            addInnerBeforeA: function (b) {
                ...
                for (var d =
                    0, f = A.length; d < f; d++) A[d].apply(this, arguments)
                ...
                if (!a) return d ? null : [];
                for (var g = b.data.key.children, l = d ? null :
                ...
                if (j.isArray(a)) {
                    ...
                    for (c = 0, d = a.length; c < d; c++) i[a[c][g]] &&
                    a[c][f] != a[c][g] ? (i[a[c][g]][e] || (i[a[c][g]][e] = []), i[a[c][g]][e].push(a[c])) : h.push(a[c]);
                    return h
                } else return [a]
            }
        }, m = {
    ...
    H = function (b, a) {
        var c = h.getSetting(b.data.treeId);
        j.apply(c.callback.beforeMouseDown,
            [c.treeId, a], !0) && j.apply(c.callback.onMouseDown, [b, c.treeId, a]);
        return !0
    };
    I = function (b, a) {
        var c = h.getSetting(b.data.treeId);
    ...
    var j = {
        ...
        addNodes: function (b, a, c, d) {
            if (!b.data.keep.leaf || !a || a.isParent) if (j.isArray(c) || (c = [c]), b.data.simpleData.enable && (c = h.transformTozTreeFormat(b, c)), a) {
                var f =
                    k("#" + a.tId + e.id.SWITCH), g = k("#" + a.tId + e.id.ICON), l = k("#" + a.tId + e.id.UL);
            ...
            for (var e = [], j = b.data.key.children, k = 0, m = c.length; k < m; k++) {
                var o = c[k];
                if (f) {
                    var s = (d ? d : h.getRoot(b))[j].length ==
                        c.length && k == 0;
            ...
            k.ajax({
                ...
                error: function (c, d, f) {
                    if (o == h.getRoot(b)._ver) {
                        ...
                        i.setNodeLineIcos(b, a);
                        b.treeObj.trigger(e.event.ASYNC_ERROR,
                            [b.treeId, a, c, d, f])
                    }
                }
            });
            ...
            if (b.callback.onNodeCreated || b.view.addDiyDom) for (var a = h.getRoot(b); a.createdNodes.length > 0;) {
                ...
                b.callback.onNodeCreated && b.treeObj.trigger(e.event.NODECREATED,
                    [b.treeId, c])
            }
            ...
            if (a) {
                ...
                if (a.open == c) j.apply(f, []); else {
                    var c = k("#" + a.tId + e.id.UL), g = k("#" + a.tId + e.id.SWITCH), n = k("#" + a.tId + e.id.ICON);
                    a.isParent ? (a.open = !a.open, a.iconOpen && a.iconClose && n.attr("style", i.makeNodeIcoStyle(b,
            ...
            a && (a.parentTId ?
                (i.expandCollapseNode(b, a, c, d), a.parentTId && i.expandCollapseParentNode(b, a.getParentNode(), c, d, f)) : i.expandCollapseNode(b, a, c, d, f))
            ...
            var d = h.getNodeName(a,
                c), d = a.view.nameIsHTML ? d : d.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
        ...
        makeUlLineClass: function (b, a) {
            ...
            if (h.getNodeCache(b, a.tId)) {
                ...
                h.removeSelectedNode(b, a);
                for (var g = 0, l = f[d].length; g <
                l; g++) if (f[d][g].tId == a.tId) {
                    f[d].splice(g, 1);
                    break
                }
                i.setFirstNode(b, f);
                ...
                if (!b.data.keep.parent && g == 0) f.isParent = !1, f.open = !1, g = k("#" + f.tId + e.id.UL), l = k("#" + f.tId + e.id.SWITCH), j = k("#" + f.tId + e.id.ICON), i.replaceSwitchClass(f, l, e.folder.DOCU), i.replaceIcoClass(f, j, e.folder.DOCU), g.css("display", "none"); else if (b.view.showLine && g > 0) {
                    ...
                    j = k("#" + n.tId + e.id.ICON);
                    f == c ? f[d].length == 1 ? i.replaceSwitchClass(n,
                        l, e.line.ROOT) : (c = k("#" + f[d][0].tId + e.id.SWITCH), i.replaceSwitchClass(f[d][0], c, e.line.ROOTS), i.replaceSwitchClass(n, l, e.line.BOTTOM)) : i.replaceSwitchClass(n, l, e.line.BOTTOM);
            ...
            var c = k("#" + a.tId + e.id.A), d = i.makeNodeFontCss(b,
                a);
            d && c.css(d)
            ...
            a.open || !j.canAsync(b, a) ? i.expandCollapseNode(b, a, !a.open) : b.async.enable ? i.asyncNode(b, a) ||
                i.expandCollapseNode(b, a, !a.open) : a && i.expandCollapseNode(b, a, !a.open)
        }
    };
    k.fn.zTree = {
        consts: {
        ...
        _z: {tools: j, view: i, event: m, data: h}, getZTreeObj: function (b) {
            ...
            b[a] = d.data.simpleData.enable ?
                h.transformTozTreeFormat(d, c) : c;
            h.initCache(d);
            m.unbindTree(d);
            m.bindTree(d);
            m.unbindEvent(d);
            ...
            c = {
                setting: d, addNodes: function (a, b, c) {
                    ...
                    a = !!a;
                    i.expandCollapseSonNode(this.setting,
                        null, a, !0);
                    return a
                    ...
                    return !a ? null : h.getNodesByParam(this.setting, c ? c[this.setting.data.key.children] : h.getNodes(this.setting),
                        a, b)
                    ...
                    if (!a) return null;
                    for (var b = d.data.key.children, c = a.parentTId ? a.getParentNode() : h.getRoot(this.setting), e = 0, i = c[b].length; e < i; e++) if (c[b][e] ==
                        a) return e;
                    return -1
                    ...
                    return h.transformToArrayFormat(this.setting,
                        a)
...
(function (k) {
            ...
            function c(b) {
                ...
                if (z.dragFlag == 1) {
                    ...
                    var s = o < g.edit.drag.borderMax &&
                        o > g.edit.drag.borderMin, I = n < g.edit.drag.borderMax && n > g.edit.drag.borderMin,
        ...
        tools: {
            ...
            addEditBtn: function (b, a) {
                ...
                if (a != c && (!b.data.keep.leaf || !a || a.isParent ||
                    ...
                    } else if (c.isLastNode) x = h[g].length - 1, t = h[g][x - 1], t.isLastNode =
                        !0; else for (n = 0, m = h[g].length; n < m; n++) if (h[g][n].tId == c.tId) {
                        x = n;
                        break
                    }
                    x >= 0 && h[g].splice(x, 1);
                ...
                if (c !== a.level) {
                    var b = k("#" + a.tId), e = k("#" + a.tId + d.id.A), f = k("#" + a.tId + d.id.UL), c = "level" + c,
                        a = "level" + a.level;
                    b.removeClass(c);
                    b.addClass(a);
                    e.removeClass(c);
            ...
            setSonNodeLevel: function (b, a, c) {
                if (c) {
                    ...
                    if (c[d]) for (var a = 0, f = c[d].length; a < f; a++) c[d][a] && p.setSonNodeLevel(b,
                        c, c[d][a])
                }
            }
        }
    ...
    p.addInitProxy(function (b) {
        var a = b.target, c = p.getSetting(b.data.treeId), e = b.relatedTarget, f = "", l = null, j = "", g = null,
            k = null;
        if (h.eqs(b.type, "mouseover")) {
            ...
            tagName: "a",
            attrName: "treeNode" + d.id.A
        }]), k || (f = "remove", j = "hoverOutNode"); else if (h.eqs(b.type, "mousedown") &&
            (k = h.getMDom(c, a, [{
                tagName: "a",
                attrName: "treeNode" + d.id.A
    ...
    h.uCanDo = function (b, a) {
        var c = p.getRoot(b);
        return a && (h.eqs(a.type, "mouseover") || h.eqs(a.type, "mouseout") || h.eqs(a.type, "mousedown") || h.eqs(a.type, "mouseup")) ?
            !0 : !c.curEditNode && (N ? N.apply(e, arguments) : !0)
    }
})(jQuery);
